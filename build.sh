...
if [ "$(git rev-parse --abbrev-ref HEAD)" == "master" ]; then
    docker tag biigle/app:latest docker.pkg.github.com/biigle/core/app:latest
    docker tag biigle/worker:latest docker.pkg.github.com/biigle/core/worker:latest
    docker tag biigle/web:latest docker.pkg.github.com/biigle/core/web:latest
