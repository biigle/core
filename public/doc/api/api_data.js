define({ "api": [
  ...
  },
  {
    ...
    "description": "<p>A user can only destroy their own API tokens</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>The API token ID</p>"
          }
        ]
      }
    },
    "version": "0.0.0",
    "filename": "app/Http/Controllers/Api/ApiTokenController.php",
    "groupTitle": "ApiTokens"
  },
  {
    "type": "get",
    "url": "api-tokens",
    ...
    "description": "<p>A user can only see their own API tokens</p>",
    "success": {
      "examples": [
        {
          "title": "Success response:",
  ...
  },
  {
    ...
    "description": "<p>This action is allowed only by session cookie authentication. The token of the response is displayed only this single time!</p>",
    "parameter": {
      "fields": {
        "Required parameters": [
          {
            ...
            "optional": false,
            "field": "purpose",
            "description": "<p>A short description of the purpose of the new token</p>"
          }
        ]
      },
      "examples": [
        {
          "title": "Request example:",
          "content": "purpose: 'Token for my custom Python script'",
          "type": "String"
        }
      ]
    },
      ...
      "fields": {
        ...
        "Attributes that can be updated": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "media_type_id",
            "description": "<p>The ID of the media type of the transect.</p>"
          },
          {
            "group": "Attributes that can be updated",
            "type": "String",
            "optional": false,
            "field": "url",
            "description": "<p>The base URL ot the image files. Can be a local path like <code>/vol/transects/1</code> or a remote path like <code>https://example.com/transects/1</code>. Updating the URL will trigger a re-generation of all transect image thumbnails.</p>"
          }
        ]
      }
    },
        ...
        "Required parameters": [
          {
            ...
            "optional": false,
            "field": "password",
            "description": "<p>The password of the global administrator.</p>"
          }
        ],
        "Parameter": [
          {
        ...
        "Attributes that can be updated": [
          {
            ...
            "optional": false,
            "field": "email",
            "description": "<p>The new email address of the user. Must be unique for all users. If this parameter is set, an additional <code>auth_password</code> needs to be present, containing the user's current password.</p>"
          },
          {
            "group": "Attributes that can be updated",
            "type": "String",
            "optional": false,
            "field": "password",
            "description": "<p>The new password of the user. If this parameter is set, an additional <code>password_confirmation</code> parameter needs to be present, containing the same new password, as well as an <code>auth_password</code> parameter, containing the old password.</p>"
          },
          {
            "group": "Attributes that can be updated",
            "type": "String",
      ...
      "fields": {
        ...
        "Attributes that can be updated": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "role_id",
            "description": "<p>Global role of the user. If the role should be changed, an additional <code>auth_password</code> field is required, containing the password of the global administrator that requests the change.</p>"
          }
        ]
      },
      "examples": [
