...
use Biigle\Modules\Export\Support\Reports\Volumes\Report as BaseReport;
...
class Report extends BaseReport
{
    ...
    {
        $skip = [];
        $exportArea = Volume::convert($this->volume)->exportArea;
    ...
    protected function getAnnotationSession()
    {
        if (!$this->annotationSession) {
            $this->annotationSession = $this->volume
                ->annotationSessions()
