 ...
 * @description Service managing the image filter of the volume index page
 */
angular.module('biigle.volumes').service('filter', function (VOLUME_ID, VOLUME_IMAGES, filterSubset, filterExclude, $q) {
        "use strict";

        var DEFAULT_MODE = 'filter';
        var _this = this;

        var rulesLocalStorageKey = 'biigle.volumes.' + VOLUME_ID + '.filter.rules';
        var modeLocalStorageKey = 'biigle.volumes.' + VOLUME_ID + '.filter.mode';
        ...
        var refresh = function () {
            angular.copy(VOLUME_IMAGES, ids);
            var rule;
