 ...
 * @description Controller for the filter feature of the volumes page
 */
angular.module('biigle.volumes').controller('FilterController', function ($scope, images, filter) {
        "use strict";
