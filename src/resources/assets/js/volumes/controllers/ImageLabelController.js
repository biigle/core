 ...
 */
angular.module('biigle.volumes').controller('ImageLabelController', function ($scope, labels, VOLUME_ID, keyboard) {
        "use strict";

        // favourite labels that can be selected with the hotkeys
        var favourites = [];
        var maxFavourites = 9;
        var favouritesStorageKey = 'biigle.volumes.' + VOLUME_ID + '.label-favourites';
