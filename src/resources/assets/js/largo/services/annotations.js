 ...
 * @description Service for managing the dismissed/replaced annotation labels of the Largo view
 */
angular.module('biigle.largo').service('annotations', function (VOLUME_IMAGES, largo, labels, images, msg) {
        "use strict";
        ...
        this.handleSelectedLabel = function (label) {
            ...
            if (labelMapCache.hasOwnProperty(id)) {
                ...
                loading = true;
                labelMapCache[id] = largo.getAnnotations(id);
        ...
        this.save = function () {
            ...
            updateAnnotationCount();
            images.updateFiltering();
            var promise = largo.save(dismissed, changed).$promise;
