...
@section('manual-content')
    <div class="row">
        ...
        <div class="panel panel-info">
            <div class="panel-body">
                <p>
                    <strong class="text-info">Example:</strong> You want to measure the intra observer agreement of the user Jessica for objects of interest in the transect <em>T</em>. Meanwhile Jacob is already performing an annotation task on the same transect (e.g. manually annotating all laserpoints). His annotation task should not be affected by your study.
                </p>
                <p>
                    First make sure that you have admin access and Jessica has at least editor access to transect <em>T</em>. Now create an annotation session <em>A</em> for transect <em>T</em> (e.g. lasting 48&nbsp;h from 2016-10-19 to 2016-10-21), add Jessica as member and activate the hide own annotations option. Then create a second annotation session <em>B</em> that starts with a certain delay after session <em>A</em> and has the same duration (e.g. from 2016-10-24 to 2016-10-26), again with Jessica as member and hide own annotations activated.
                </p>
                <p>
        ...
        <p>
            In contrast to the intra observer agreement to measure the reproducibility of annotations of a single user, the inter observer agreement can be used to measure the reproducibility of annotations between multiple different users. In other words this is a measure for how well different users find the same objects of interest and assign the same label to it. For this, all users are asked to annotate objects of interest in a transect at the same time. While the users are annotating, they must not see the annotations of the other users. By comparing the annotations of different users, the inter observer agreement can be calculated. This type of annotation study requires the <em>hide other annotations</em> ( <span class="label label-default">hide other</span> ) option of annotation sessions. If this option is activated, members of the annotation session will not see annotations of other users while the annotation session is running.
        </p>
        <div class="panel panel-info">
            <div class="panel-body">
                <p>
