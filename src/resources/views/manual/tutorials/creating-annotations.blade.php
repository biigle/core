...
@section('manual-content')
    <div class="row">
        ...
        <p>
            In many ways, creating a video annotation works the same as creating a still image annotation. First you select a label from the <i class="fa fa-tags"></i> label trees tab in the sidebar, then you activate a tool in the toolbar at the bottom of the video and finally you draw the annotation in the video. But now comes an additional step. After you have drawn the annotation in the video, you have to finish it by clicking on the <button class="btn btn-xs btn-default"><i class="fa fa-check"></i></button> button that appears when a tool is activated. Only after a new annotation has been finished, it is created and saved.
        </p>
        <p class="text-center">
            <a href="{{asset('vendor/videos/images/manual/creating_annotations_1.jpg')}}"><img src="{{asset('vendor/videos/images/manual/creating_annotations_1.jpg')}}" width="40%"></a>
        </p>
        <p>
            Congratulations, you have just created your first <i>single-frame video annotation</i>. A single-frame video annotation marks an object or a region of interest (ROI) in a single frame of the video. Most of the time, however, objects or ROIs are moving and visible in multiple frames of the video and you might want to model this with your annotations, too. This is where multi-frame video annotations, or simply <i>annotation clips</i>, come in and the video annotation tool begins to deviate from the still image annotation tool.
        </p>

        <h3><a name="annotation-clips"></a>Annotation Clips</h3>
        <p>
            An annotation clip is composed of multiple <i>keyframes</i>. Each keyframe is essentially a single-frame video annotation, marking an object or ROI at a single point of time in the video. With several keyframes, an annotation clip can track an object or ROI while it changes its shape, size or position in the video.
        </p>
        <p>
            Let's step through the process of creating a new annotation clip. Everything starts with a single-frame annotation. Select a label from the <i class="fa fa-tags"></i> label trees tab, activate a tool in the toolbar and draw the annotation in the video. But this time, don't finish the annotation yet. Instead, play the video and pause it again after a few seconds when your object or ROI has moved a bit. Now draw a second annotation that matches the new position, size or shape of the object at the current time. Repeat this process and add new keyframes until the object or ROI is no longer visible in the video. Each keyframe remains slightly visible while the new annotation clip is created. Finally, finish the new annotation clip with a click on the <button class="btn btn-xs btn-default"><i class="fa fa-check"></i></button> button. When you return to the start of the annotation clip, you will see that the annotation follows the object or ROI that you have annotated, interpolating between keyframes.
        </p>
        <p class="text-center">
            <a href="{{asset('vendor/videos/images/manual/creating_annotations_2.jpg')}}"><img src="{{asset('vendor/videos/images/manual/creating_annotations_2.jpg')}}" width="32%"></a>
            <a href="{{asset('vendor/videos/images/manual/creating_annotations_3.jpg')}}"><img src="{{asset('vendor/videos/images/manual/creating_annotations_3.jpg')}}" width="32%"></a>
            <a href="{{asset('vendor/videos/images/manual/creating_annotations_4.jpg')}}"><img src="{{asset('vendor/videos/images/manual/creating_annotations_4.jpg')}}" width="32%"></a>
        </p>
        <p class="text-center">
            <video src="{{asset('vendor/videos/images/manual/creating_annotations_5.mp4')}}" controls width="50%"></video>
        ...
        <p>
            To apply automatic object tracking, create a single keyframe of a point or circle annotation clip that marks the object at the first point of time at which it is visible in the video. Now instead of finishing the annotation with the <button class="btn btn-xs btn-default"><i class="fa fa-check"></i></button> button, click the <button class="btn btn-xs btn-default"><i class="fa fa-project-diagram"></i></button> button. This creates the new annotation clip and starts object tracking in the background. A running object detection is indicated with a striped keyframe element in the <a href="{{route('manual-tutorials', ['videos', 'navigating-timeline'])}}">timeline</a>. Depending on the size of the video and the duration that the annotated object is visible, the object detection can run for several minutes. The new annotation clip will automatically be updated when the object detection has finished.
        </p>
        <p class="text-center">
            <a href="{{asset('vendor/videos/images/manual/creating_annotations_6.jpg')}}"><img src="{{asset('vendor/videos/images/manual/creating_annotations_6.jpg')}}" width="32%"></a>
            <a href="{{asset('vendor/videos/images/manual/creating_annotations_7.jpg')}}"><img src="{{asset('vendor/videos/images/manual/creating_annotations_7.jpg')}}" width="32%"></a>
            <video src="{{asset('vendor/videos/images/manual/creating_annotations_8.mp4')}}" controls width="32%" style="vertical-align: middle;"></video>
            <br><small class="text-muted">Video source: <a href="#ref1">[1]</a></small>
        </p>
        <p>
