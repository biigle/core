...
@section('manual-content')
    <div class="row">
        ...
        <p>
            Image labels are labels that are attached to a whole image instead of annotations. Only project editors or admins can modify image labels. To attach a new image label, select a label in the <a href="#label-trees-tab">label trees tab</a> (or use a <a href="{{route('manual-tutorials', ['annotations', 'shortcuts'])}}">shortcut</a>), then open the image label tab and click the <button class="btn btn-default btn-xs"><i class="fa fa-plus"></i></button> button in the top right corner. To detach an image label, click the <button class="close" style="float: none;"><span aria-hidden="true">×</span></button> button next to it.
        </p>
        <p>
