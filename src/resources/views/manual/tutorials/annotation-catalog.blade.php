...
<div class="row">
    ...
    <p>
        To open the annotation catalog of a label tree, visit the label tree overview and click on <button class="btn btn-default btn-xs"><i class="fa fa-book"></i> Annotation catalog</button>. Now choose a label in the sidebar on the right. If there are any annotations to which the selected label is attached and you have access to, thumbnails will be displayed in the grid on the left. You can navigate the thumbnail grid in the same way than the image grid of the <a href="{{route('manual-tutorials', ['volumes', 'volume-overview'])}}">volume overview</a>. Click on an annotation thumbnail to open the annotation tool in a new window and focus on the annotation.
    </p>
    <p>
