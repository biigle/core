...
@section('manual-content')
    <div class="row">
        ...
        <p class="text-center">
            ...
            <a href="{{asset('vendor/videos/images/manual/editing_annotations_3.jpg')}}"><img src="{{asset('vendor/videos/images/manual/editing_annotations_3.jpg')}}" width="33%"></a>
        </p>
        ...
        <p class="text-center">
            ...
            <a href="{{asset('vendor/videos/images/manual/editing_annotations_4.jpg')}}"><img src="{{asset('vendor/videos/images/manual/editing_annotations_4.jpg')}}" width="33%" style="margin-left: 50px;"></a><br>
            <a href="{{asset('vendor/videos/images/manual/editing_annotations_7.jpg')}}"><img src="{{asset('vendor/videos/images/manual/editing_annotations_7.jpg')}}" width="33%"></a>
            <a href="{{asset('vendor/videos/images/manual/editing_annotations_5.jpg')}}"><img src="{{asset('vendor/videos/images/manual/editing_annotations_5.jpg')}}" width="33%" style="margin-left: 50px;"></a>
        </p>
