...
<div class="row">
    ...
    <p>
        To download a label tree, press the <button class="btn btn-default btn-xs"><i class="fa fa-download"></i> Download</button> button in the label tree overview. This will start the download of the label tree export file. The label tree export file can be useful in many scenarios. You can use it to publish the label tree on platforms like <a href="https://zenodo.org/">Zenodo</a> so it gets a DOI and can accompany one of your publications. You can also use the export file to import the label tree in another BIIGLE instance.
    </p>
    <p>
