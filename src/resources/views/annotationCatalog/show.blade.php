...
<div id="annotation-catalog-container" class="sidebar-container">
    ...
    <sidebar :show-buttons="false" open-tab="labels">
        <sidebar-tab class="largo-tab" name="labels" icon="tags" title="Label tree">
            <power-toggle v-cloak class="largo-tab__button" :active="showAnnotationOutlines" title-off="Show annotation outlines" title-on="Hide annotation outlines" v-on:on="showOutlines" v-on:off="hideOutlines" :disabled="noLabelSelected">Show annotation outlines</power-toggle>
