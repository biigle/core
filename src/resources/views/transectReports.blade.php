    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            ...
            <form data-ng-controller="TransectReportRequestController" data-ng-submit="submit()">
                    ...
                    <div class="col-sm-7">
                        <div class="form-group">
                            ...
                            <div class="btn-group btn-group-justified">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="Request an annotation report" data-ng-click="selectType('annotations')" data-ng-class="{active:wantsType('annotations')}">Annotation report</button>
                                </div>
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="Request an image label report" data-ng-click="selectType('image-labels')" data-ng-class="{active:wantsType('image-labels')}">Image label report</button>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="row" data-ng-if="wantsType('annotations')">
                    <div class="col-sm-7">
                        <div class="form-group" data-ng-class="{'has-error':error.annotationSession}">
                            ...
                            <div class="ng-cloak help-block" data-ng-if="error.annotationSession" data-ng-bind="error.annotationSession"></div>
                        </div>
                    </div>
                    <div class="col-sm-5 help-block ng-cloak" data-ng-if="form.options.annotationSession">
                        Only annotations that were created during the selected annotation session will be included in the report.
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-7" data-ng-class="{'has-error':error.separateLabelTrees}">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" data-ng-model="form.options.separateLabelTrees" disabled> Separate label trees
                            </label>
                        </div>
                        <div class="ng-cloak help-block" data-ng-if="error.separateLabelTrees" data-ng-bind="error.separateLabelTrees"></div>
                    </div>
                    <div class="col-sm-5 help-block ng-cloak" data-ng-if="form.options.separateLabelTrees">
                        Annotations belonging to different label trees will be separated to different files/sheets.
                    </div>
                </div>
                <div class="row" data-ng-if="wantsType('annotations')">
                    <div class="col-sm-7" data-ng-class="{'has-error':error.exportArea}">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" data-ng-model="form.options.exportArea"> Restrict to export area
                            </label>
                        </div>
                        <div class="ng-cloak help-block" data-ng-if="error.exportArea" data-ng-bind="error.exportArea"></div>
                    </div>
                    <div class="col-sm-5 help-block ng-cloak" data-ng-if="form.options.exportArea">
                        Annotations that are outside of the export area will be discarded for this report.
                    </div>
                </div>
                <div class="ng-cloak alert alert-success" data-ng-if="state.success">
                ...
                <input type="submit" name="submit" value="Request this report" title="Request this report" class="btn btn-success pull-right" data-ng-disabled="state.loading">
            </form>
        </div>
    </div>
</div>
