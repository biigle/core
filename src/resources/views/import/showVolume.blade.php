...
<div class="row">
    ...
    @else
        <div id="volume-import-container">
            ...
            @include('sync::import.labelConflictsPanel')
            ...
            <div v-if="!hasNoChosenItems" v-cloak>
                ...
                <typeahead class="typeahead--block" v-bind:items="availableProjects" placeholder="Project name" title="Select a target project" v-on:select="selectTargetProject" v-bind:clear-on-select="true" v-bind:template="typeaheadTemplate"></typeahead>
