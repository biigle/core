...
<div class="sidebar__controls clearfix">
	<div class="btn-group">
		...
		@if ($editMode)
			<button class="btn btn-inverse" data-ng-click="toggleFoldout('categories')" title="Toggle label category list 𝗧𝗮𝗯" data-ng-class="{active:(foldout=='categories')}" data-ng-controller="SidebarCategoryFoldoutController"><span class="glyphicon glyphicon-list" aria-hidden="true"></span></button>
		@endif
