...
<div class="sidebar__controls clearfix">
    <div class="btn-group">
		...
		@endif
        <button class="btn btn-default" data-ng-click="toggleFoldout('filters')" title="@{{supportsFilters() ? 'Toggle image filter foldout' : 'Filters are not available for this image'}}" data-ng-class="{active:(foldout=='filters')}" data-ng-controller="FiltersControlController" data-ng-disabled="!supportsFilters()"><span class="glyphicon glyphicon-adjust" aria-hidden="true"></span></button>
