    ...
    <div class="annotation-canvas__toolbar">
        ...
        @can('add-annotation', $image)
            ...
            {{--<div class="btn-group edit-controls" data-ng-controller="EditControlsController">
                ...
                <button class="btn btn-sm" title="Move selected annotations 𝗠" data-ng-click="toggleMoving($event)" data-ng-class="{active:isMoving()}"><span class="glyphicon glyphicon-move" aria-hidden="true"></span></button>
