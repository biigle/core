    ...
    @empty
        <div class="row">
            <div class="alert alert-info col-md-6 col-md-offset-3">
                You do not belong to any projects yet. You can <a href="{{route('projects-create')}}">create your own project</a> or request a project admin to add you to a project.
            </div>
        </div>
    @endforelse
    <div class="row">
