...
/***/ "../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./src/resources/assets/js/components/filteringTab.vue?vue&type=script&lang=js":
/*!*******************************************************************************************************************************************************************************************************************************!*\
  !*** ../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./src/resources/assets/js/components/filteringTab.vue?vue&type=script&lang=js ***!
  \*******************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  methods: {
    filterAnnotation: function filterAnnotation() {
      console.log("Test");
    }
  }
});
...
/* harmony import */ var _components_filteringTab__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/filteringTab */ "./src/resources/assets/js/components/filteringTab.vue");
/* harmony import */ var _import__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../import */ "./src/resources/assets/js/import.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../constants */ "./src/resources/assets/js/constants.js");
 ...
 */
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  mixins: [_import__WEBPACK_IMPORTED_MODULE_5__.LoaderMixin],
  components: {
    labelTrees: _import__WEBPACK_IMPORTED_MODULE_5__.LabelTrees,
    sidebar: _import__WEBPACK_IMPORTED_MODULE_5__.Sidebar,
    sidebarTab: _import__WEBPACK_IMPORTED_MODULE_5__.SidebarTab,
    powerToggle: _import__WEBPACK_IMPORTED_MODULE_5__.PowerToggle,
    ...
    filteringTab: _components_filteringTab__WEBPACK_IMPORTED_MODULE_4__["default"]
  },
  data: function data() {
    return {
      user: null,
  ...
  computed: {
    ...
    sortedAnnotations: function sortedAnnotations() {
      ...
      if (this.sortingSequence.length > 0) {
        ...
        annotations.forEach(function (a) {
          ...
          map[a.type === _constants__WEBPACK_IMPORTED_MODULE_6__.VIDEO_ANNOTATION ? 'v' + a.id : 'i' + a.id] = a;
        });
    ...
    dismissedImageAnnotationsToSave: function dismissedImageAnnotationsToSave() {
      return this.packDismissedToSave(this.dismissedAnnotations.filter(function (a) {
        return a.type === _constants__WEBPACK_IMPORTED_MODULE_6__.IMAGE_ANNOTATION;
      }));
    },
    dismissedVideoAnnotationsToSave: function dismissedVideoAnnotationsToSave() {
      return this.packDismissedToSave(this.dismissedAnnotations.filter(function (a) {
        return a.type === _constants__WEBPACK_IMPORTED_MODULE_6__.VIDEO_ANNOTATION;
      }));
    },
  ...
  methods: {
    getAnnotations: function getAnnotations(label) {
      ...
      if (!this.annotationsCache.hasOwnProperty(label.id)) {
        ...
        }, _import__WEBPACK_IMPORTED_MODULE_5__.handleErrorResponse);
      } else {
    ...
    gotAnnotations: function gotAnnotations(label, response) {
      ...
      var annotations = [];
      if (imageAnnotations) {
        annotations = annotations.concat(this.initAnnotations(label, imageAnnotations, _constants__WEBPACK_IMPORTED_MODULE_6__.IMAGE_ANNOTATION));
      }
      if (videoAnnotations) {
        annotations = annotations.concat(this.initAnnotations(label, videoAnnotations, _constants__WEBPACK_IMPORTED_MODULE_6__.VIDEO_ANNOTATION));
      }
    ...
    save: function save() {
      ...
      this.performSave({
        ...
        (0,_import__WEBPACK_IMPORTED_MODULE_5__.handleErrorResponse)(response);
      });
    },
    handleSessionSaved: function handleSessionSaved(event) {
      if (event.id == this.waitForSessionId) {
        this.finishLoading();
        _import__WEBPACK_IMPORTED_MODULE_5__.Messages.success('Saved. You can now start a new re-evaluation session.');
        this.step = 0;
    ...
    handleSessionFailed: function handleSessionFailed(event) {
      if (event.id == this.waitForSessionId) {
        this.finishLoading();
        _import__WEBPACK_IMPORTED_MODULE_5__.Messages.danger('There was an unexpected error.');
      }
    },
    ...
    initializeEcho: function initializeEcho() {
      _import__WEBPACK_IMPORTED_MODULE_5__.Echo.getInstance()["private"]("user-".concat(this.user.id)).listen('.Biigle\\Modules\\Largo\\Events\\LargoSessionSaved', this.handleSessionSaved).listen('.Biigle\\Modules\\Largo\\Events\\LargoSessionFailed', this.handleSessionFailed);
    },
  ...
  watch: {
    annotations: function annotations(_annotations) {
      _import__WEBPACK_IMPORTED_MODULE_5__.Events.$emit('annotations-count', _annotations.length);
    },
    dismissedAnnotations: function dismissedAnnotations(annotations) {
      _import__WEBPACK_IMPORTED_MODULE_5__.Events.$emit('dismissed-annotations-count', annotations.length);
    },
    step: function step(_step) {
      _import__WEBPACK_IMPORTED_MODULE_5__.Events.$emit('step', _step);
    },
  ...
  created: function created() {
    ...
    window.addEventListener('beforeunload', function (e) {
      if (_this7.hasDismissedAnnotations) {
        e.preventDefault();
        e.returnValue = '';
...
/***/ "./src/resources/assets/js/components/filteringTab.vue":
/*!*************************************************************!*\
  !*** ./src/resources/assets/js/components/filteringTab.vue ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _filteringTab_vue_vue_type_template_id_fa939292__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./filteringTab.vue?vue&type=template&id=fa939292 */ "./src/resources/assets/js/components/filteringTab.vue?vue&type=template&id=fa939292");
/* harmony import */ var _filteringTab_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./filteringTab.vue?vue&type=script&lang=js */ "./src/resources/assets/js/components/filteringTab.vue?vue&type=script&lang=js");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _filteringTab_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _filteringTab_vue_vue_type_template_id_fa939292__WEBPACK_IMPORTED_MODULE_0__.render,
  _filteringTab_vue_vue_type_template_id_fa939292__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "src/resources/assets/js/components/filteringTab.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./src/resources/assets/js/components/filteringTab.vue?vue&type=script&lang=js":
/*!*************************************************************************************!*\
  !*** ./src/resources/assets/js/components/filteringTab.vue?vue&type=script&lang=js ***!
  \*************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_filteringTab_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./filteringTab.vue?vue&type=script&lang=js */ "../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./src/resources/assets/js/components/filteringTab.vue?vue&type=script&lang=js");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_filteringTab_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./src/resources/assets/js/components/filteringTab.vue?vue&type=template&id=fa939292":
/*!*******************************************************************************************!*\
  !*** ./src/resources/assets/js/components/filteringTab.vue?vue&type=template&id=fa939292 ***!
  \*******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_filteringTab_vue_vue_type_template_id_fa939292__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_filteringTab_vue_vue_type_template_id_fa939292__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_filteringTab_vue_vue_type_template_id_fa939292__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./filteringTab.vue?vue&type=template&id=fa939292 */ "../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./src/resources/assets/js/components/filteringTab.vue?vue&type=template&id=fa939292");
...
/***/ "../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./src/resources/assets/js/components/filteringTab.vue?vue&type=template&id=fa939292":
/*!************************************************************************************************************************************************************************************************************************************************!*\
  !*** ../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./src/resources/assets/js/components/filteringTab.vue?vue&type=template&id=fa939292 ***!
  \************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function () {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "filtering-tab" }, [
    _c("div", { staticClass: "list-group filter-list-group" }, [
      _c(
        "button",
        {
          staticClass: "list-group-item",
          attrs: { title: "Filter by annotation type" },
          on: { click: _vm.filterAnnotation },
        },
