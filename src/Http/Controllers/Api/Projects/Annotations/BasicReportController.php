...
class BasicReportController extends ProjectReportController
{
     ...
     * @apiParam (Optional arguments) {Boolean} separateLabelTrees If `true`, separate annotations with labels of different label trees to different plots for each volume.
