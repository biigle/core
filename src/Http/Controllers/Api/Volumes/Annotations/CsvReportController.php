...
use Biigle\Modules\Export\Support\Reports\Volumes\Annotations\CsvReport;
...
class CsvReportController extends VolumeReportController
{
    ...
    /**
     * @api {post} volumes/:id/reports/annotations/csv Generate a new csv annotation report
     * @apiGroup Volumes
     * @apiName GenerateCsvVolumeAnnotationReport
