...
class TransectImageMetadataController extends Controller
{
     ...
     * @apiDescription This endpoint allows adding or updating image metadata like geo coordinates for transect images. Because the metadata is supplied as an uploaded file, this endpoint can only be accessed with a `multipart/form-data` request (not `application/json`).
     *
     * @apiParam {Number} id The transect ID.
     *
     * @apiParam (Required attributes) {File} file CSV file with metadata for the transect images. See CSV columns for the possible columns. Each column may occur only once. There must be at least one column other than `filename`.
     *
