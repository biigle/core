...
class DropAttributesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        ...
        */
        Schema::create('attributes', function (Blueprint $table) {
            ...
            $table->enum('type', ['integer', 'double', 'string', 'boolean']);
        ...
        */
        ...
        Schema::create('attribute_transect', function (Blueprint $table) {
            ...
            $table->unique(['attribute_id', 'transect_id']);
        ...
        Schema::create('attribute_image', function (Blueprint $table) {
            ...
            $table->unique(['attribute_id', 'image_id']);
        ...
        Schema::create('attribute_label', function (Blueprint $table) {
            ...
            $table->unique(['attribute_id', 'label_id']);
        ...
        Schema::create('annotation_attribute', function (Blueprint $table) {
            ...
            $table->unique(['attribute_id', 'annotation_id']);
