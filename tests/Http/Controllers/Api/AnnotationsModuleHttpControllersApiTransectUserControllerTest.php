...
class AnnotationsModuleHttpControllersApiTransectUserControllerTest extends ApiTestCase {
    ...
    public function testIndex() {
        ...
        $this->doTestApiRoute('GET', "/api/v1/transects/{$tid}/annotation-users/find/joe");

        $this->beUser();
        $this->get("/api/v1/transects/{$tid}/annotation-users/find/joe");
        ...
        $this->get("/api/v1/transects/{$tid}/annotation-users/find/user")
            ->seeJsonEquals([
                [
                    'id' => $user1->id,
                    'firstname' => $user1->firstname,
