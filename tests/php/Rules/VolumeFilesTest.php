...
class VolumeFilesTest extends TestCase
{
    ...
    {
        $validator = new VolumeFilesStub('', MediaType::IMAGE->value);
    ...
    {
        $validator = new VolumeFilesStub('', MediaType::VIDEO->value);
    ...
    public function testCheckImageFilesExist()
    {
        ...
        $validator = new VolumeFiles('test://images', MediaType::IMAGE->value);
    ...
    public function testCheckVideoFilesExist()
    {
        ...
        $validator = new VolumeFiles('test://videos', MediaType::VIDEO->value);
