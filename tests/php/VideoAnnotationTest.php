...
class VideoAnnotationTest extends ModelTestCase
{
    ...
    {
        $this->model->shape_id = Shape::POINT;
    ...
    {
        $this->model->shape_id = Shape::RECTANGLE;
        $this->model->points = [
            [0, 0, 10, 0, 20, 20, 0, 20],
    ...
    {
        $this->model->shape_id = Shape::CIRCLE;
    ...
    {
        $this->model->shape_id = Shape::LINE;
    ...
    {
        $this->model->shape_id = Shape::POLYGON;
        $this->expectException(Exception::class);
        $this->model->interpolatePoints(0.5);
    }
    ...
    {
        $this->model->shape_id = Shape::WHOLE_FRAME;
        $this->expectException(Exception::class);
        $this->model->interpolatePoints(0.5);
    }
