...
class ProjectAnnotationLabelsTest extends ApiTestCase
{
    public function testGetProjectAnnotationLabels()
    {
        ...
        $videoVolume = VolumeTest::create(['media_type_id' => MediaType::VIDEO->value, 'creator_id' => $this->volume()->creator_id]);
    ...
    {
        $id = $this->project()->id;
        $volId = $this->volume(['media_type_id' => MediaType::VIDEO->value])->id;
