...
class AbundanceReportGeneratorTest extends TestCase
{
    ...
    public function testGenerateReportSeparateLabelTreesFileSorting()
    {
        $project = ProjectTest::create();
        ...
        $label1 = LabelTest::create(['label_tree_id' => $lt]);
        $label2 = LabelTest::create(['label_tree_id' => $lt]);
        $label3 = LabelTest::create();

        $image = ImageTest::create(['filename' => 'a.jpg']);
        ...
        // page for first label tree
        $mock->shouldReceive('putCsv')
            ->once()
            ->with([$image->filename, 1, 1])
            ->ordered();
        ...
        $mock->shouldReceive('putCsv')
            ->once()
            ->with([$image3->filename, 0, 0])
            ->ordered();

        $mock->shouldReceive('putCsv')
            ->once()
            ->with([$image4->filename, 0, 0])
            ->ordered();

        // page for second label tree
        $mock->shouldReceive('putCsv')
            ->once()
        ...
        $mock->shouldReceive('putCsv')
            ->once()
            ->with([$image3->filename, 1])
            ->ordered();

        $mock->shouldReceive('putCsv')
            ->once()
            ->with([$image4->filename, 0])
            ->ordered();
    ...
    public function testGenerateReportSeparateUsersAggregateLabelsRestrictToEmptyChildLabels()
    {
        $project = ProjectTest::create();
        $volume = VolumeTest::create();
        $project->addVolumeId($volume);
        ...
        // Use only child label
        $emptyLabel = LabelTest::create(['label_tree_id' => $lt->id]);
        $emptyLabelChild = LabelTest::create([
            'parent_id' => $emptyLabel->id,
            'label_tree_id' => $emptyLabel->label_tree_id,
        ]);

        // Aggregate labels
        $emptyLabel2 = LabelTest::create(['label_tree_id' => $lt->id]);
        $emptyLabelChild2 = LabelTest::create([
            'parent_id' => $emptyLabel2->id,
            'label_tree_id' => $emptyLabel2->label_tree_id,
        ]);

        $root = LabelTest::create(['label_tree_id' => $lt2->id]);
        ...
        $mock->shouldReceive('putCsv')
            ->once()
            ->with(['image_filename', $emptyLabelChild->name, $emptyLabel2->name, $root->name]);

        $mock->shouldReceive('putCsv')
            ->once()
            ->with([$i1->filename, 0, 0, 1]);

        $mock->shouldReceive('putCsv')
            ->once()
            ->with([$i2->filename, 0, 0, 0]);
        ...
        $generator = new AbundanceReportGenerator([
            'separateUsers' => true,
            'aggregateChildLabels' => true,
            'onlyLabels' => [$emptyLabelChild->id, $emptyLabel2->id, $emptyLabelChild2->id, $root->id]
        ]);
        $generator->setSource($volume);
        $mock = Mockery::mock();
        $mock->shouldReceive('run')->once();
    ...
    public function testGenerateReportAllLabelsNewestLabels()
    {
        $volume = VolumeTest::create();
        $project = ProjectTest::create();
        $project->addVolumeId($volume);
        ...
        $l1 = LabelTest::create(['label_tree_id' => $lt->id]);
        $l2 = LabelTest::create(['label_tree_id' => $lt->id]);
        // Empty label should be included
        $l3 = LabelTest::create(['label_tree_id' => $lt->id]);

        $i1 = ImageTest::create(['volume_id' => $volume->id, 'filename' => 'a.jpg']);
        $i2 = ImageTest::create(['volume_id' => $volume->id, 'filename' => 'b.jpg']);
        // Empty images should be included in report
        $i3 = ImageTest::create(['volume_id' => $volume->id, 'filename' => 'c.jpg']);

        $a = ImageAnnotationTest::create(['image_id' => $i1->id]);
    ...
    public function testGenerateReportAllLabelsRestrictToLabels()
    {
        $volume = VolumeTest::create();
        $project = ProjectTest::create();
        $project->addVolumeId($volume);
        ...
        $l3 = LabelTest::create(['label_tree_id' => $lt->id]);
        // Empty label should be included
        $l4 = LabelTest::create(['label_tree_id' => $lt->id]);
    ...
    public function testGenerateReportAllLabelsRestrictLabels()
    {
        ...
        $a2 = ImageAnnotationTest::create(['image_id' => $image]);
        ImageAnnotationLabelTest::create([
            'annotation_id' => $a2->id,
            'label_id' => $l2->id,
        ]);

        $a3 = ImageAnnotationTest::create(['image_id' => $image2]);
        ImageAnnotationLabelTest::create([
            'annotation_id' => $a3->id,
            'label_id' => $l3->id
        ]);

        $a4 = ImageAnnotationTest::create(['image_id' => $image2]);
        ImageAnnotationLabelTest::create([
            'annotation_id' => $a4->id,
            'label_id' => $l4,
        ]);
        ...
        // Only filtered labels should be counted
        $mock->shouldReceive('putCsv')
            ->once()
            ->with(['a.jpg', 0, 1, 0, 0]);
