...
use Biigle\Modules\Export\Support\Reports\Volumes\Annotations\ExtendedReportGenerator;
...
class ExtendedReportGeneratorTest extends TestCase
{
    ...
    {
        $report = new ExtendedReportGenerator(VolumeTest::make());
    ...
    public function testGenerateReport()
    {
        ...
        $generator = new ExtendedReportGenerator($volume);
        $mock = Mockery::mock();
    ...
    public function testGenerateReportSeparateLabelTrees()
    {
        ...
        $generator = new ExtendedReportGenerator($image->volume, [
