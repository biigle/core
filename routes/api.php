...
$router->put('pending-volumes/{id}/label-map', 'PendingVolumeController@updateLabelMap');
$router->put('pending-volumes/{id}/user-map', 'PendingVolumeController@updateUserMap');
