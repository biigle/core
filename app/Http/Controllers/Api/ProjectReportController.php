...
class ProjectReportController extends Controller
{
     ...
     * @apiParam (Optional arguments) {Boolean} all_labels If `true`, include all labels of the project's label trees in the abundance report, even labels that were not used in any annotation (with an abundance of 0). Only available for the abundance report. Cannot be used together with `newest_label`, `only_labels` or `aggregate_child_labels`.
     ...
     * @apiParam (Optional arguments) {Boolean} skip_attributes If `true`, remove attribute column. Only available for the CSV report.
     *
