...
<nav class="navbar navbar-inverse navbar-noradius">
	<div class="container-fluid">
		<div class="navbar-header">
      	<a class="navbar-brand logo logo-inverse" href="dashboard">
      	...
      	<li>
      		{{ Form::open(array('action' => 'HomeController@doLogout', 'class' => 'navbar-form')) }}
				<div class="form-group">
					{{Form::button('<i class="glyphicon glyphicon-log-out"></i>', array('type' => 'submit', 'class' => 'btn btn-default', 'title' => 'Logout'))}}
				</div>
				{{ Form::close() }}
			</li>
      </ul>
