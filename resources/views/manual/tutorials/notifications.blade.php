...
@section('manual-content')
    <div class="row">
        ...
        <p>
            A click on the action link usually transfers you directly to the cause of the notification (like a new system message or a downloadable file). You can mark unread notifications as read by clicking on the <button class="btn btn-default btn-xs" title="Mark as read"><i class="glyphicon glyphicon-ok"></i></button> button or clicking on the action link. This will make the message immediately disappear from the list of unread notifications. To view older notifications that were already marked as read, click the "All notifications" link in the navigation on the left of the notification center.
        </p>
        <p>
