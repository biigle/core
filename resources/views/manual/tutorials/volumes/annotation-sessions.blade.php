...
@section('manual-content')
    <div class="row">
        ...
        <p>
            Existing annotation sessions can be used to filter <a href="{{route('manual-tutorials', ['reports', 'reports-schema'])}}">volume annotation reports</a>. A report restricted to an annotation session only includes annotations that belong to this session (i.e. created by a member between the start an end dates of the annotation session).
        </p>
        <p>
