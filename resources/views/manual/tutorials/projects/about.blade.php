...
@section('manual-content')
    <div class="row">
        ...
        <p>
            In addition to everything that a guest can do, <strong>editors</strong> can create and modify annotations, annotation labels and image/video labels. However, they cannot delete annotation labels or image/video labels that were created by other users. Editors should be the default choice for new project members.
        </p>
        ...
        <p>
            An <strong>expert</strong> can do everything that an editor can do. In addition to that, they can modify or delete annotations or image/video labels <em>of other users</em> as well. Choose this role if a user should be able to "supervise" other editors but should not be a full project admin.
        </p>
        <p>
