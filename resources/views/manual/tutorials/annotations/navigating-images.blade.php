...
@section('manual-content')
    <div class="row">
        ...
        <p class="text-center">
            <a href="{{asset('assets/images/manual/navigating_images_volare_2.jpg')}}"><img src="{{asset('assets/images/manual/navigating_images_volare_2.jpg')}}" width="32%"></a>
            <a href="{{asset('assets/images/manual/navigating_images_volare_3.jpg')}}"><img src="{{asset('assets/images/manual/navigating_images_volare_3.jpg')}}" width="32%"></a>
            <a href="{{asset('assets/images/manual/navigating_images_volare_4.jpg')}}"><img src="{{asset('assets/images/manual/navigating_images_volare_4.jpg')}}" width="32%"></a>
        </p>
        <p>
        ...
        <p class="text-center">
            <a href="{{asset('assets/images/manual/navigating_images_lmm_2.jpg')}}"><img src="{{asset('assets/images/manual/navigating_images_lmm_2.jpg')}}" width="32%"></a>
            <a href="{{asset('assets/images/manual/navigating_images_lmm_3.jpg')}}"><img src="{{asset('assets/images/manual/navigating_images_lmm_3.jpg')}}" width="32%"></a>
            <a href="{{asset('assets/images/manual/navigating_images_lmm_4.jpg')}}"><img src="{{asset('assets/images/manual/navigating_images_lmm_4.jpg')}}" width="32%"></a>
        </p>
