...
<pre>
{
   ...
   "autoload": {
      "psr-4": {
         ...
         <p>
            Second, the dependencies of the package are delcared. Here, the annotations package requires the <code>biigle/volumes</code> package (since otherwise there is no way reaching the "annotator" application, but it can have other reasons, too).
         </p>
         <p>
