<div id="volume-metadata-upload" class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <p class="text-muted">
            Learn more about @if ($volume->isImageVolume()) image @else video @endif metadata and the CSV file format in the <a href="{{route('manual-tutorials', ['volumes', 'image-metadata'])}}">manual</a>.
        </p>
    </div>
</div>
