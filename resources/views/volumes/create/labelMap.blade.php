...
<div class="container">
    <div id="create-volume-form-step-5" class="col-sm-10 col-sm-offset-1 col-lg-8 col-lg-offset-2">
        ...
        <p class="text-muted">
            Each label from the metadata file must be mapped to a label in the BIIGLE database. Some labels can be mapped automatically. To map the remaining labels manually, enter a label name to select an existing label or click the plus button to create a new label.
        </p>
