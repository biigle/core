<ul class="nav nav-tabs project-tabs">
    <li role="presentation" @if ($activeTab === 'labels') class="active" @endif>
        <a href="{{route('label-trees', $tree->id)}}" title="Show the labels of this label tree"><i class="fa fa-tags"></i> Labels <span class="badge" id="labels-count">{{$tree->labels()->count()}}</span></a>
    </li>
