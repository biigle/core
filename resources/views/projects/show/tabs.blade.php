<ul class="nav nav-tabs project-tabs">
    ...
    <li role="presentation" @if ($activeTab === 'members') class="active" @endif>
        <a href="#" title="Show the members of the project"><i class="fa fa-users" id="project-members-count"></i> Members <span class="badge">{{readable_number($project->users()->count())}}</span></a>
    </li>
