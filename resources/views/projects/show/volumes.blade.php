...
<div id="projects-show-volumes" class="project-volumes">
    ...
    <section class="uiv">
        <statistics-modal :show-modal="showModal" :statistics-data="statisticsData" @close-modal="showModal = false"></statistics-modal>
    </section>
