        ...
        <div class="col-xs-6">
            <span class="top-bar pull-right">
                @can('update', $project)
                    ...
                    <scrollable-typeahead :items="attachableLabelTrees" placeholder="Attach label tree" v-on:select="attachTree" :clear-on-select="true" more-info="description" title="Attach a label tree" v-on:fetch="fetchAvailableLabelTrees"></scrollable-typeahead>
                @else
