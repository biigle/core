...
<sidebar v-cloak open-tab="labels" v-on:open="handleOpenTab">
    <sidebar-tab class="largo-tab" name="labels" icon="tags" title="Label trees">
        ...
        @endcan
        <label-trees class="largo-tab__label-trees" :trees="labelTrees" :show-favourites="true" :show-custom-order="true" v-on:select="handleSelectedLabel" v-on:deselect="handleDeselectedLabel" v-on:clear="handleDeselectedLabel"></label-trees>
    </sidebar-tab>
