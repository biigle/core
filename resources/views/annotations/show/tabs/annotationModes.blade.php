...
@push('scripts')
<script type="text/html" id="annotation-modes-tab-template">
    <div class="annotator-tab annotator-tab--annotation-modes">
        ...
        @can('add-annotation', $image)
            <div class="sidebar-tab__section">
                ...
                <power-toggle
                    :active="isRandomSamplingActive"
                    title-off="Start random sampling of annotations"
                    title-on="Stop random sampling of annotations 𝗘𝘀𝗰"
                    v-on:on="startRandomSampling"
                    v-on:off="resetMode"
                    icon-on="stop"
            ...
            <div class="sidebar-tab__section">
                ...
                <power-toggle
                    :active="isRegularSamplingActive"
                    title-off="Start regular sampling of annotations"
                    title-on="Stop regular sampling of annotations 𝗘𝘀𝗰"
                    v-on:on="startRegularSampling"
                    v-on:off="resetMode"
                    icon-on="stop"
                    icon-off="play"></power-toggle>
