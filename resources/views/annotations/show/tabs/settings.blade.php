<sidebar-tab name="settings" icon="cog" title="Settings" :highlight="highlightSettingsTab">
    <settings-tab v-cloak :image="image" :images-area="imagesArea" :current-id="imageId"
        :image-filenames="imageFilenames" :ids="allImagesIds" v-on:change="handleSettingsChange"></settings-tab>
</sidebar-tab>
