        ...
        <div class="admin-add-category panel-body">
            <form class="form" data-ng-submit="addLabel()">
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="new-label-parent" placeholder="Parent" data-ng-model="selected.label" data-uib-typeahead="label.name for label in labels | filter:$viewValue | limitTo:10" data-uib-typeahead-on-select="selectItem($item)" data-ng-disabled="!labels.length" title="Parent label" />
                            <span class="input-group-btn">
